...
# the following is a sample pipeline for data including categorical types:
...
### 3.Splitting Data
# This part including implement of k-fold validification analysis to avoid potential bias in model
...
# At this point, 'models' contains the trained model for each fold
