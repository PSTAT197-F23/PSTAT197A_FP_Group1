...
This following graph represents the distribution of 'fraud'. It is noticeable that the data is balanced.
...
xgb_smote.test <-  xgb.DMatrix(data = test_smote.x, label = test_smote.y)
```
